...
@interface VRope : NSObject {
    ...
    @public
	NSMutableArray *vPoints;          //points on the rope
	NSMutableArray *vSticks;          //stick on the rope
...
-(void)reset;         
-(void)fadeOut;
-(VRope *)cutRopeInStick:(VStick *)stick newBodyA:(b2Body*)newBodyA newBodyB:(b2Body*)newBodyB;    //start implementing the cut effect
#endif
